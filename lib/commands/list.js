  ...
  builder: function(yargs) {
    return yargs
      ...
      .option('o', {
        alias: 'order',
        default:  'asc',
        describe: 'choose order',
        choices: ['asc', 'desc']
      })
      .option('b', {
        alias: 'order-by',
        default:  'fid',
        describe: 'choose order by',
        choices: ['id', 'fid', 'percent']
      })
      .positional('keyword', {
        type:     'string',
        default:  '',
...
cmd.handler = function(argv) {
  ...
  core.filterProblems(argv, function(e, problems) {
    ...
    const f = argv.o == 'asc' ? function(v){ return v} : function(v) { return -v};
    problems = _.sortBy(problems, x => f(x[argv.b]));
