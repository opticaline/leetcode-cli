    ...
    core.submitProblem(problem, function(e, results) {
      ...
      if (result.ok) {
        ...
        core.getSubmission({id: result.id}, function(e, submission) {
          if (submission && submission.runtimeDistributionFormatted && submission.runtimeDistributionFormatted.distribution) {
            const d = submission.runtimeDistributionFormatted.distribution;
            ...
            b = 100 - b;
            printLine(result, 'Your runtime beats %d %% of %s submissions', b, submission.runtimeDistributionFormatted.lang);
            return;
          }
